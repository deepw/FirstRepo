/*
We are looking for correct, clean and maintainable code (production quality
code).  Please keep it short and avoid duplication of code.  In particular, you
should strive to minimize the number of looping, branching, and conditional
statements in your code.

Please use simple linear search (not binary search).  Please implement the
given function, and include functional tests.
*/
